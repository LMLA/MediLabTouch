/*
 * File: app/controller/PhysicianTabPanelController.js
 *
...
Ext.define('MediLab.controller.PhysicianTabPanelController', {
    extend: 'Ext.app.Controller',
    alias: 'controller.physiciantabpanelcontroller',
    config: {
        refs: {
    ...
    onPhysicianMenuListDisclosure: function(list, record, target, index, e, options) {
        ...
        switch(index) {
            ...
            case 3:
            var a=Ext.getCmp("physicianNavView"), b=Ext.getCmp("testSearch"); 

            console.log("valor de physicianNavView: ", a); 
            console.log("valor de testSearch: ", b); 
            a.setActiveItem(b);
